 ...
 * @tree: pointing to the root node of the tree to measure the height of
 *
...
/**
 * binary_tree_level - this perform a function on a specific level of a binary tree
 * @tree: pointing to the root of the tree
