...
/**
 * greater_than - this check if all values in the tree are greater than a value
 * @tree: pointing to the tree to check
...
/**
 * less_than - this check if all values in the tree are less than a specific value
 * @tree: pointing to the tree to check
 * @val: value to check against
 *
 * Return: 1 if true, 0 if false
